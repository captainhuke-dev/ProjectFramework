---
document_type: UAAC_HUMAN_INSTALL_WALKTHROUGH_ROOT_VIEW
audience: HUMAN
normative: false
authority_effect: NONE
truth_authority: NONE
agent_execution: DO_NOT_EXECUTE
canonical_agent_install_protocol: universal-ai-agent-constitution/INSTALL-UAAC.md
canonical_release_copy: universal-ai-agent-constitution/HUMAN-INSTALL-WALKTHROUGH-TH.md
canonical_release_commit: 5a309d8d38046bf3e8cd4beb2fc82a872f211cad
example_values_are_current_truth: false
---

# FOR HUMAN READING ONLY — ตัวอย่างติดตั้ง UAAC จากศูนย์บน Windows

> เอกสารนี้ถูกวางไว้ที่ root เพื่อให้มนุษย์กดอ่านได้ง่ายจาก `README.md`  
> เป็น **คำอธิบายและตัวอย่างสำหรับมนุษย์เท่านั้น** ไม่ใช่ Agent protocol, ไม่ใช่ Project Law, ไม่ใช่ Current Truth และห้าม Agent นำ path, repository, branch, command หรือตัวอย่างในเอกสารนี้ไป execute โดยอัตโนมัติ
>
> Agent/Installer ต้อง fresh-read และปฏิบัติตาม [`universal-ai-agent-constitution/INSTALL-UAAC.md`](universal-ai-agent-constitution/INSTALL-UAAC.md) พร้อม resolve Project จริงก่อนทำงานเสมอ
>
> UAAC v4.2.0 release package ยังคงเก็บ release copy ของ walkthrough ไว้ที่ `universal-ai-agent-constitution/HUMAN-INSTALL-WALKTHROUGH-TH.md` เพื่อรักษา package identity ที่ remote-verified แล้ว
...
```text
Human ต้องการเข้าใจ → HUMAN-INSTALL-WALKTHROUGH-TH.md
Agent ต้องติดตั้ง       → universal-ai-agent-constitution/INSTALL-UAAC.md
