...
- **Publication:** `PUBLISHED_TO_PR_20` on branch `work/project-upgrade-command`, PR `#20` targeting `main`; merge state is external and must be verified fresh (`commit ≠ push ≠ merge`).
