...
- **Publication:** `MERGED_TO_MAIN` via PR `#20`; merge commit `ba817a6c4a6ccbe5a33cab63868e90330095b5e6`; canonical `main` was post-merge verified local/`origin`/remote aligned at that commit.
