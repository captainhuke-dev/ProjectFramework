...
- **parallelizable_with:** `[]`
- **priority:** `HIGH`
- **readiness:** `USER_APPROVED_DIRECTION / WRITTEN_SPEC_SELF_REVIEWED / WRITTEN_SPEC_USER_APPROVED / HERMES_DESIGNATED_EXECUTOR / TASK_READY_GATE_PASS / EXECUTING`
...
- **Plan State:** `WRITTEN / SELF_REVIEWED / WRITTEN_SPEC_USER_APPROVED / EXECUTION_HANDOFF_REQUIRED`.
...
- **Execution State:** Phase 0 `PASS` (baseline `1.20.0 / 1.0.0 / format 3` proven; V3 collision matrix retained/already-satisfied/rejected); Phase 1 RED scenarios `591–620` allocated, contiguous, unique (ceiling now `620`); RED proven because TASK-059 production contracts are absent from the 1.20 baseline. Phase 2 implementation in progress.
