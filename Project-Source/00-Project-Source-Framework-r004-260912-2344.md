...
supersedes: "00-Project-Source-Framework-r003-260911-1459.md"
framework_root: true
inherits_from: []
...
## 1. Framework 1.16 Pin and Incorporated Normative Source

This canonical ProjectFramework self-host is reconciled to **ProjectFramework 1.16.0 / Project Source Schema 1.0.0** under `MIG-003` and the ACTOR-001 explicit `[Goal]` plus bounded Root Governance mutation approval on 2026-09-12. This is canonical-upstream self-host reconciliation, not an ordinary consuming-Project `[Project Upgrade]`.

The incorporated Framework 1.16 semantics are bound to the exact local normative checkpoint below. Canonical merged release `main` at `7ffe1f871d7c0f6a8f64a9c3211425a792cde870` established Framework 1.16.0; TASK-049 adds the same-version canonical self-host lifecycle clarification before this Root promotion. These source files do **not** become a second Project authority: their pinned text is incorporated by this `FRAMEWORK-001`; this root remains Project governance authority.

```yaml
framework_source_provenance:
  repository: "captainhuke-dev/ProjectFramework"
  canonical_branch: "main"
  canonical_merged_release_commit: "7ffe1f871d7c0f6a8f64a9c3211425a792cde870"
  self_host_reconciliation_source_ref: "task049-self-hosting-reconcile"
  self_host_reconciliation_source_commit: "9f5471b690df09d1993cb931a653fd85b35a2cd0"
  incorporated_framework_source_tree: "a84e7bd0ed56bd73a7e2cb6c642885d9fefeb24a"
  framework_version: "1.16.0"
  schema_version: "1.0.0"
  release_format_version: 3
  captured_at: "2026-09-12T23:44:57+07:00"
  provenance_status: "VERIFIED_LOCAL_CHECKPOINT"
```

Pinned Framework 1.16 source set incorporated here:

- `Framework-Source/FRAMEWORK-RELEASE.yaml` — blob `784b3c8eadd8996811166d060ef10fa537dcaa4b`
- `Framework-Source/SKILL.md` — blob `a3af9e2d760f6d00401bd5dacd29b699e948998b`
- `Framework-Source/references/framework-governance-amendment-260912-task049-canonical-self-hosting.md` — blob `4b90696aaa144d9b1196a7a47582fd1c603d6148`
- `Framework-Source/references/core-governance-rules.md` — blob `b623cb64d384f9ccd0fe976473456ae074fe23ec`
- `Framework-Source/templates/00-project-source-framework.md` — blob `12c746e8db6d92decf7573efa799c2825bebb065`
- `Framework-Source/templates/core-document-skeletons.md` — blob `4c7e00b331f6fc8e2d7a9e5f49a8a92847b05306`
...
Project Source Framework Pin: 1.16.0
