...
supersedes: "02-Project-Overview-r002-260829-1901.md"
...
- ProjectFramework local Project Source Framework pin: `1.15.0`; Schema: `1.0.0`.
- Canonical reusable Framework distribution: Framework `1.15.0` / Schema `1.0.0` / release format `3`.
...
The repository contains the reusable Framework distribution under `Framework-Source/` and development records under `docs/superpowers/`. The authoritative `Project-Source/` governs ProjectFramework itself and is pinned to Framework `1.15.0` through `MIG-002`. Framework distribution truth and Project-local governance truth remain separate even when they share the same version.
...
- **Framework upstream release:** verified reusable distribution release, currently `1.15.0` at the upgrade baseline.
- **Project Source Framework pin:** Framework revision governing this initialized Project, currently `1.15.0`.
