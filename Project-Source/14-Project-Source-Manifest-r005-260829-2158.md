...
- `01` — `Project-Source/01-Project-Source-Index-r005-260829-2158.md`
- `02` — `Project-Source/02-Project-Overview-r002-260829-1901.md`
- `03` — `Project-Source/03-Current-State-r005-260829-2158.md`
- `04` — `Project-Source/04-Decision-Log-r001-260829-1707.md`
- `05` — `Project-Source/05-Requirements-r001-260829-1707.md`
- `09` — `Project-Source/09-Handoff-r005-260829-2158.md`
...
- `14` — `Project-Source/14-Project-Source-Manifest-r005-260829-2158.md`
...
Latest completed Framework candidate: TASK-039 / commit 0f2ecfde7112a7d7d101e316fc0c3069c8ece5db
Latest completed Framework candidate tree: a3adaeef91d3a729f9d14d570400ed73b47ee3a2
Latest verified Framework-Source tree: 2101c2d22b9d23d0bae3517a6462c4895edecf15
Latest completed Framework verification: AFFECTED 43/43 PASS; RELEASE_FULL 220/220 PASS
Latest release evidence: docs/superpowers/evidence/2026-08-29-task-039-persistent-goal-command-release-full.md
Latest release evidence commit: b7f63bb949536d2ba68b4322a564533c19fe1c88
Current governance/design checkpoint: TASK-024 design spec commit 87f6e9b0020751ba6c60e8b07ca52471974b84bf
Source Ref: main (dynamic; verify when material)
Captured At: 2026-08-29T21:58:00+07:00
Provenance Status: VERIFIED for cited local checkpoints; remote publication NOT_PUSHED
```
