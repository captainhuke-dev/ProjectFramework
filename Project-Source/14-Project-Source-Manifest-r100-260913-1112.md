...
- `01` — `Project-Source/01-Project-Source-Index-r100-260913-1112.md`
- `02` — `Project-Source/02-Project-Overview-r004-260912-2344.md`
- `03` — `Project-Source/03-Current-State-r096-260913-1112.md`
- `04` — `Project-Source/04-Decision-Log-r003-260912-2344.md`
- `05` — `Project-Source/05-Requirements-r003-260912-2344.md`
- `09` — `Project-Source/09-Handoff-r096-260913-1112.md`
- `10` — `Project-Source/10-Change-Log-r094-260913-1112.md`
- `11` — `Project-Source/11-Actor-Registry-r003-260912-2344.md`
- `12` — `Project-Source/12-Authorization-Registry-r040-260913-1112.md`
- `13` — `Project-Source/13-Evidence-Registry-r093-260913-1112.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r100-260913-1112.md`
- `15` — `Project-Source/15-Action-Registry-r093-260913-1112.md`
...
- `91` — `Project-Source/91-Project-Management-Control-r057-260913-1112.md`
...
Audit / Terminal Evidence: EVD-096 / EVD-097 / CHG-096 / CHG-097
...
TASK-049 self-host reconciliation remains canonical on `origin/main` through PR #31 merge `4039be4`. TASK-050 issue mutations are complete under now-terminated `AUTH-018`; push/PR/merge publication of this local ledger reconciliation remains separately governed and is not authorized by OUT-018.
