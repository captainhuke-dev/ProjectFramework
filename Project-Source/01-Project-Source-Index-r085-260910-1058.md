...
supersedes: "01-Project-Source-Index-r083-260906-1635.md"
...
→ 01-Project-Source-Index-r085-260910-1058.md
→ 03-Current-State-r082-260910-1058.md
→ task-specific routing
→ 09-Handoff-r082-260910-1058.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r085-260910-1058.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r082-260910-1058.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r082-260910-1058.md` | ACTIVE |
| `10` | `10-Change-Log-r079-260910-1058.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r028-260910-1058.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r079-260910-1058.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r085-260910-1058.md` | ACTIVE |
| `15` | `15-Action-Registry-r080-260910-1058.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r044-260910-1058.md` | ACTIVE |
...
- Current state: `03-Current-State-r082-260910-1058.md`.
- Continuation: `09-Handoff-r082-260910-1058.md`.
- Evidence: `13-Evidence-Registry-r079-260910-1058.md`.
- Manifest: `14-Project-Source-Manifest-r085-260910-1058.md`.
...
- **Verification Finding:** current README/SKILL drift requires a bounded 1.15 correction pass after written-spec review.
- **Publication:** NOT_AUTHORIZED / NOT_PUSHED.
- **Exact Next Action:** Human review of the written reconciliation design before correction/implementation execution.
