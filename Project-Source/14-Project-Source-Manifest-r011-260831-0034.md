...
- `01` — `Project-Source/01-Project-Source-Index-r011-260831-0034.md`
- `02` — `Project-Source/02-Project-Overview-r002-260829-1901.md`
- `03` — `Project-Source/03-Current-State-r011-260831-0034.md`
- `04` — `Project-Source/04-Decision-Log-r001-260829-1707.md`
- `05` — `Project-Source/05-Requirements-r001-260829-1707.md`
- `09` — `Project-Source/09-Handoff-r011-260831-0034.md`
- `10` — `Project-Source/10-Change-Log-r009-260831-0034.md`
- `11` — `Project-Source/11-Actor-Registry-r001-260829-1707.md`
- `12` — `Project-Source/12-Authorization-Registry-r001-260829-1707.md`
- `13` — `Project-Source/13-Evidence-Registry-r009-260831-0034.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r011-260831-0034.md`
- `15` — `Project-Source/15-Action-Registry-r009-260831-0034.md`
...
Current integration checkpoint: Pull Request #21 OPEN / MERGEABLE / CLEAN; technical gate PASS; independent review blocked by confirmed reviewer-capability/authorization-path gap; TASK-025 design follows integration disposition
...
Provenance Status: VERIFIED; published PR/remote feature-branch head 714108a526db1a492d980690e50b1b484b88f6a1 is OPEN against main; Framework-Source tree remains d66803fc41c540efcf072e9e45eb98c83d1f1bb5; origin/main unchanged at eb231ee2d1d83b42455ab2f3cab250d4d442fda0; local reviewer-capability checkpoint commit may advance local HEAD and remains unpushed unless separately authorized; independent review not run; merge not executed
```
