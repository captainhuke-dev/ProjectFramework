...
→ 01-Project-Source-Index-r025-260901-0813.md
→ 03-Current-State-r025-260901-0813.md
→ task-specific routing
→ 09-Handoff-r025-260901-0813.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r025-260901-0813.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r025-260901-0813.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r025-260901-0813.md` | ACTIVE |
| `10` | `10-Change-Log-r019-260901-0813.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r005-260901-0813.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r019-260901-0813.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r025-260901-0813.md` | ACTIVE |
| `15` | `15-Action-Registry-r023-260901-0813.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r009-260901-0813.md` | ACTIVE |
...
- `TASK-041 Portable Installation Bootstrap & Project Settings Handoff`: DONE / publication `MERGED_TO_MAIN` through Pull Request `#26`; merge `2bfe5efbb24480bc44dbd8e949ed632af4d759ee`; Framework-Source tree `06ce4013473ec014e70d8d3233f6132aa90339fd`; post-merge reconciliation terminalized under `OUT-002 ACHIEVED / AUTH-002 TERMINATED / ACT-011 DONE / ENV-002 EXPIRED`.
- TASK-041 reconciliation checkpoint: `c5741ab56799d44cefa39f30da55bd23bf85bf03`; this terminal revision must be observed as canonical `origin/main` after fast-forward push before any external completion claim.
- `TASK-025 Project Knowledge Layer / Compounding Knowledge Contract`: remains TODO and is not started by this reconciliation.
- Current state: `03-Current-State-r025-260901-0813.md`.
- Continuation: `09-Handoff-r025-260901-0813.md`.
- Evidence: `13-Evidence-Registry-r019-260901-0813.md`.
- Manifest: `14-Project-Source-Manifest-r025-260901-0813.md`.
