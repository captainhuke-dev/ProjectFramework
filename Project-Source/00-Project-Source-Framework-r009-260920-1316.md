...
supersedes: "00-Project-Source-Framework-r008-260920-1016.md"
framework_root: true
inherits_from: []
...
## 1. Framework 1.21 Pin and Incorporated Normative Source

This canonical ProjectFramework self-host is reconciled to **ProjectFramework 1.21.0 / Project Source Schema 1.0.0** under `MIG-007` as the post-merge self-host reconciliation of TASK-059, authorized by ACTOR-001 on 2026-09-20. The reconciliation is `COMPLETED / PERSISTED / NOT_PENDING` on canonical `main`; this is canonical-upstream post-release self-host reconciliation to the already-verified Framework 1.20.0 distribution, not an ordinary consuming-Project `[Project Upgrade]`.

The incorporated Framework 1.21 semantics are bound to the exact verified release below. The Framework 1.21.0 distribution (TASK-059 V3 Forward-Port Runtime Control Contract) was released at candidate `0d51582b553953a176dcb3f40fe942e177588028` and preserves the independently verified Framework-Source tree `ea6aa84b179c0f470fd6231cf364e6d8a5a59e72`; TASK-059 is the release lineage layered on TASK-058 Wave A V2 Deterministic Execution Foundation, TASK-057 AI-ControlTower Governance Support Layer, TASK-051/TASK-052, and the TASK-049 canonical self-hosting contract. These source files do **not** become a second Project authority: their pinned text is incorporated by this `FRAMEWORK-001`; this root remains Project governance authority.

```yaml
framework_source_provenance:
  repository: "captainhuke-dev/ProjectFramework"
  canonical_branch: "main"
  canonical_release_candidate_commit: "0d51582b553953a176dcb3f40fe942e177588028"
  self_host_reconciliation_source_ref: "task059-post-merge-self-host-reconcile-1.21"
  reconciliation_task: "TASK-059"
  incorporated_framework_source_tree: "ea6aa84b179c0f470fd6231cf364e6d8a5a59e72"
  framework_version: "1.21.0"
  schema_version: "1.0.0"
  release_format_version: 3
  captured_at: "2026-09-20T13:16:07.724+07:00"
  provenance_status: "VERIFIED_CANONICAL_RELEASE"
  canonical_integration_commit: "7602fb10d238afcbd818874e07edb7820061b561"
```

Pinned Framework 1.21 source set incorporated here:

- `Framework-Source/FRAMEWORK-RELEASE.yaml` — blob `38e8bd2632a78c7c38ce1472bcf74367064bc68b`
- `Framework-Source/SKILL.md` — blob `e4833efb72f6675b46ca58e66f059829487f2941`
- `Framework-Source/references/framework-governance-amendment-260920-task059-v3-forward-port-runtime-contract.md` — blob `8d21340aa531d35778f4eb4e3be34d6d2808a27f`
...
- `Framework-Source/references/core-governance-rules.md` — blob `cf172174698350d931e81d066466354274c0bf4a`
- `Framework-Source/templates/00-project-source-framework.md` — blob `6e503fd200c2a50c53289f5a14c204ccafa651f1`
- `Framework-Source/templates/core-document-skeletons.md` — blob `cef5b215b5533673d7184f375728290d5025da2d`
...
- This `MIG-007` self-host reconciliation **does not change any Project Location Binding value**; the binding above is preservation of the predecessor root truth.
...
`MIG-002` remains the historical `ASSESSED_PATH` 1.7.0 → 1.15.0 Project upgrade described in active `16`. `MIG-007` is the current canonical self-host post-release reconciliation to Framework 1.21.0 and is not an ordinary consuming-Project `[Project Upgrade]`; `MIG-006` (1.19.0 to 1.20.0) remains the immediately-preceding historical reconciliation. Preservation, rollback, evidence, history, verification, and promotion gates are not skipped.
...
## 10. Registered Commands and Current Framework 1.21 Response Semantics
...
Framework 1.21 mandatory visible response close in the pinned Framework semantics is:
...
Nothing follows `[Reason]` under the pinned Framework 1.21 contract. `[Next Goal]` is presentation-only and never creates authority. `[Chat]` and `[Required Read]` remain valid internal Handoff/continuation semantics but are not mandatory visible Framework 1.21 close fields.

## 11. Optional Framework 1.10–1.14 Surfaces

The cumulative 1.21 pin supports, without automatically materializing:
...
No `PSR-*` is materialized at this revision. Add a Project-Specific Rule only through a governed future `FRAMEWORK-001` revision with required approval; it may specialize but never weaken pinned Framework 1.21 semantics.
...
Project Source Framework Pin: 1.21.0
...
Self-Host Reconciliation: MIG-007 / CANONICAL_SELF_HOST_POST_RELEASE_RECONCILIATION / COMPLETED / PERSISTED / NOT_PENDING
```
