...
supersedes: "02-Project-Overview-r004-260912-2344.md"
...
- ProjectFramework canonical self-host Project Source Framework pin: `1.18.0`; Schema: `1.0.0`.
- Canonical reusable Framework distribution: Framework `1.18.0` / Schema `1.0.0` / release format `3`.
...
The repository contains the reusable Framework distribution under `Framework-Source/` and development records under `docs/superpowers/`. The authoritative `Project-Source/` governs ProjectFramework itself and is self-host reconciled to Framework `1.18.0` through `MIG-004`. Framework distribution truth and Project-local governance truth remain separate authorities even when canonical self-hosting requires their release identity to converge.
...
- **Framework upstream release:** verified reusable distribution release, currently `1.18.0` with TASK-052 Project Upgrade One-Session Fast Path layered on TASK-049 canonical self-hosting.
- **Project Source Framework pin:** Framework revision governing this canonical self-host Project, currently `1.18.0`.
