...
- `01` — `Project-Source/01-Project-Source-Index-r055-260902-1603.md`
- `02` — `Project-Source/02-Project-Overview-r002-260829-1901.md`
- `03` — `Project-Source/03-Current-State-r053-260902-1603.md`
- `04` — `Project-Source/04-Decision-Log-r001-260829-1707.md`
- `05` — `Project-Source/05-Requirements-r001-260829-1707.md`
- `09` — `Project-Source/09-Handoff-r053-260902-1603.md`
- `10` — `Project-Source/10-Change-Log-r049-260902-1603.md`
- `11` — `Project-Source/11-Actor-Registry-r001-260829-1707.md`
- `12` — `Project-Source/12-Authorization-Registry-r014-260902-1603.md`
- `13` — `Project-Source/13-Evidence-Registry-r049-260902-1603.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r055-260902-1603.md`
- `15` — `Project-Source/15-Action-Registry-r051-260902-1603.md`
...
- `91` — `Project-Source/91-Project-Management-Control-r030-260902-1603.md`
...
Publication: MERGED_TO_MAIN / PERSISTED — PR #27 / merge bdae13896ebec08235d5ef7101f189fa6861d801 / checkpoint 9ba7ea520b5237307ef0b0cd806154cf7cbfe7e4
Pre-PR hygiene: EVD-048 / diff-hygiene correction; Framework-Source unchanged
Next action: push terminal reconciliation commit to canonical main and fresh-verify; then none
