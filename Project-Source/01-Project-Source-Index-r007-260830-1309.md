...
→ 01-Project-Source-Index-r007-260830-1309.md
→ 03-Current-State-r007-260830-1309.md
→ task-specific routing
→ 09-Handoff-r007-260830-1309.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r007-260830-1309.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r007-260830-1309.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r007-260830-1309.md` | ACTIVE |
...
| `14` | `14-Project-Source-Manifest-r007-260830-1309.md` | ACTIVE |
...
- `TASK-026 External AI Context & Disclosure Governance`: design state `USER_APPROVED_DESIGN / WRITTEN_SPEC_REVIEW_REQUIRED`; committed spec `docs/superpowers/specs/2026-08-30-task026-external-ai-context-disclosure-design.md`; design checkpoint commit `1d61ce8790ad48bf8216af88bafd26b57e1aa979`; explicit written-spec review is required before implementation planning.
- Current state: `03-Current-State-r007-260830-1309.md`.
- Continuation: `09-Handoff-r007-260830-1309.md`.
- Evidence: `13-Evidence-Registry-r005-260829-2301.md`.
- Manifest: `14-Project-Source-Manifest-r007-260830-1309.md`.
