...
- **Validity:** ACTIVE until OUT-010 terminal reconciliation is freshly observed on canonical `origin/main`, explicit cancellation/narrowing, or material authority conflict
...
- **Status:** ACTIVE
- **Evidence:** `EVD-073` plus terminal persistence evidence
