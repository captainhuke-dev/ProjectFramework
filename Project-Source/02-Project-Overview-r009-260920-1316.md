...
supersedes: "02-Project-Overview-r008-260920-1016.md"
...
- ProjectFramework canonical self-host Project Source Framework pin: `1.21.0`; Schema: `1.0.0`.
- Canonical reusable Framework distribution: Framework `1.21.0` / Schema `1.0.0` / release format `3`.
...
The repository contains the reusable Framework distribution under `Framework-Source/` and development records under `docs/superpowers/`. The authoritative `Project-Source/` governs ProjectFramework itself and is self-host reconciled to Framework `1.21.0` through `MIG-007`. Framework distribution truth and Project-local governance truth remain separate authorities even when canonical self-hosting requires their release identity to converge.
...
- **Framework upstream release:** verified reusable distribution release, currently `1.21.0` with TASK-059 V3 Forward-Port Runtime Control Contract layered on TASK-058 Wave A V2 Deterministic Execution Foundation, TASK-057 AI-ControlTower Governance Support Layer, TASK-051/TASK-052, and TASK-049 canonical self-hosting.
- **Project Source Framework pin:** Framework revision governing this canonical self-host Project, currently `1.21.0`.
