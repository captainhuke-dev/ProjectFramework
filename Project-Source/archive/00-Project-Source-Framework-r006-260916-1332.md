...
supersedes: "00-Project-Source-Framework-r005-260913-2151.md"
framework_root: true
inherits_from: []
...
This canonical ProjectFramework self-host is reconciled to **ProjectFramework 1.19.0 / Project Source Schema 1.0.0** under `MIG-005` as the Phase 0 prerequisite of TASK-058, authorized by ACTOR-001 on 2026-09-16. This is canonical-upstream post-release self-host reconciliation to the already-verified Framework 1.19.0 distribution, not an ordinary consuming-Project `[Project Upgrade]`.
...
Self-Host Reconciliation: MIG-005 / CANONICAL_SELF_HOST_POST_RELEASE_RECONCILIATION / authorized 2026-09-16
```
