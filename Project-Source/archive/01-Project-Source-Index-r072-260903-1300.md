...
→ 01-Project-Source-Index-r072-260903-1300.md
→ 03-Current-State-r070-260903-1300.md
→ task-specific routing
→ 09-Handoff-r070-260903-1300.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r072-260903-1300.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r070-260903-1300.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r070-260903-1300.md` | ACTIVE |
| `10` | `10-Change-Log-r066-260903-1300.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r019-260903-0029.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r066-260903-1300.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r072-260903-1300.md` | ACTIVE |
| `15` | `15-Action-Registry-r068-260903-1300.md` | ACTIVE |
...
- `TASK-031 Project Event & Notification Contract`: TODO / READY; TASK-029 + TASK-030 dependencies satisfied; NOT_STARTED and requires new explicit continuation/Goal before implementation.
...
- Current state: `03-Current-State-r070-260903-1300.md`.
- Continuation: `09-Handoff-r070-260903-1300.md`.
- Evidence: `13-Evidence-Registry-r066-260903-1300.md`.
- Manifest: `14-Project-Source-Manifest-r072-260903-1300.md`.
