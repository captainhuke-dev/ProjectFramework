...
→ 01-Project-Source-Index-r004-260829-1930.md
→ 03-Current-State-r004-260829-1930.md
→ task-specific routing
→ 09-Handoff-r004-260829-1930.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r004-260829-1930.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r004-260829-1930.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r004-260829-1930.md` | ACTIVE |
| `10` | `10-Change-Log-r004-260829-1930.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r001-260829-1707.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r004-260829-1930.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r004-260829-1930.md` | ACTIVE |
| `15` | `15-Action-Registry-r004-260829-1930.md` | ACTIVE |
...
- `TASK-039`: DONE after AFFECTED `43/43` + RELEASE_FULL `220/220`; release evidence `docs/superpowers/evidence/2026-08-29-task-039-persistent-goal-command-release-full.md`.
- Next Framework `1.8.0` roadmap design action: `TASK-024 [Meeting]`; inspect `captainhuke-dev/llm-council` directly and prepare its architectural design spec before implementation.
- Current state: `03-Current-State-r004-260829-1930.md`.
- Continuation: `09-Handoff-r004-260829-1930.md`.
- Evidence: `13-Evidence-Registry-r004-260829-1930.md`.
- Manifest: `14-Project-Source-Manifest-r004-260829-1930.md`.
