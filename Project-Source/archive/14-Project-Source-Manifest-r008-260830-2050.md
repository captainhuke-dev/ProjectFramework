...
- `01` — `Project-Source/01-Project-Source-Index-r008-260830-2050.md`
- `02` — `Project-Source/02-Project-Overview-r002-260829-1901.md`
- `03` — `Project-Source/03-Current-State-r008-260830-2050.md`
- `04` — `Project-Source/04-Decision-Log-r001-260829-1707.md`
- `05` — `Project-Source/05-Requirements-r001-260829-1707.md`
- `09` — `Project-Source/09-Handoff-r008-260830-2050.md`
- `10` — `Project-Source/10-Change-Log-r006-260830-2050.md`
- `11` — `Project-Source/11-Actor-Registry-r001-260829-1707.md`
- `12` — `Project-Source/12-Authorization-Registry-r001-260829-1707.md`
- `13` — `Project-Source/13-Evidence-Registry-r006-260830-2050.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r008-260830-2050.md`
- `15` — `Project-Source/15-Action-Registry-r006-260830-2050.md`
...
Current roadmap checkpoint: TASK-025 Project Knowledge Layer design next
Source Ref: main (dynamic; verify when material)
Captured At: 2026-08-30T20:50:00+07:00
Provenance Status: VERIFIED for TASK-026 local candidate; remote publication NOT_PUSHED
```
