...
→ 01-Project-Source-Index-r031-260901-1515.md
→ 03-Current-State-r031-260901-1515.md
→ task-specific routing
→ 09-Handoff-r031-260901-1515.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r031-260901-1515.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r031-260901-1515.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r031-260901-1515.md` | ACTIVE |
| `10` | `10-Change-Log-r025-260901-1515.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r007-260901-1454.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r025-260901-1515.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r031-260901-1515.md` | ACTIVE |
| `15` | `15-Action-Registry-r029-260901-1515.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r014-260901-1515.md` | ACTIVE |
...
- `TASK-025 Project Knowledge Layer / Compounding Knowledge Contract`: IN_PROGRESS / WRITTEN_SPEC_APPROVED / persistent `OUT-003 / AUTH-003 / ACT-013 / ENV-003`; design `ec9911451f6a1271b473e7f1a02e8e3c1cd3d1f7` PASS 42/42; implementation plan committed `187c802` / self-review 43/43 PASS; Tasks 1–3 implemented: RED `33/68 FAIL` expected → structural GREEN `68/68 PASS`; Task 2 `62/62 PASS` commit `1c7be78`; Task 3 `77/77 PASS` commit `ed5aa4d`; AFFECTED `175/175 PASS`; final implementation candidate commit is this checkpoint after commit; target Framework 1.10.0 / Schema 1.0.0; publication excluded.
...
- Current state: `03-Current-State-r031-260901-1515.md`.
- Continuation: `09-Handoff-r031-260901-1515.md`.
- Evidence: `13-Evidence-Registry-r025-260901-1515.md`.
- Manifest: `14-Project-Source-Manifest-r031-260901-1515.md`.
