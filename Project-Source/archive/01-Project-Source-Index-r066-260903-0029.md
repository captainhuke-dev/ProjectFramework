...
→ 01-Project-Source-Index-r066-260903-0029.md
→ 03-Current-State-r064-260903-0029.md
→ task-specific routing
→ 09-Handoff-r064-260903-0029.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r066-260903-0029.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r064-260903-0029.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r064-260903-0029.md` | ACTIVE |
| `10` | `10-Change-Log-r060-260903-0029.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r019-260903-0029.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r060-260903-0029.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r066-260903-0029.md` | ACTIVE |
| `15` | `15-Action-Registry-r062-260903-0029.md` | ACTIVE |
...
- `TASK-036 Project Change/Event History Feed`: IN_PROGRESS / READY under `OUT-008 / AUTH-008 / ACT-020 / ENV-008`; foundation stream A; stacked on local verified Framework 1.13.0 completion `6c97832`; publication not authorized.
- `TASK-030 Cross-Project Relation Reconciliation`: IN_PROGRESS / READY under the same suite Goal; foundation stream B; parallelizable with TASK-036.
...
- Federated Change Intelligence suite target: Framework 1.14.0 / Schema 1.0.0 / release format 3; design spec next.
- Current state: `03-Current-State-r064-260903-0029.md`.
- Continuation: `09-Handoff-r064-260903-0029.md`.
- Evidence: `13-Evidence-Registry-r060-260903-0029.md`.
- Manifest: `14-Project-Source-Manifest-r066-260903-0029.md`.
