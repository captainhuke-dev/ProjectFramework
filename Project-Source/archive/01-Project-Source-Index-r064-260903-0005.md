...
→ 01-Project-Source-Index-r064-260903-0005.md
→ 03-Current-State-r062-260903-0005.md
→ task-specific routing
→ 09-Handoff-r062-260903-0005.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r064-260903-0005.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r062-260903-0005.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r062-260903-0005.md` | ACTIVE |
| `10` | `10-Change-Log-r058-260903-0005.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r017-260902-2313.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r058-260903-0005.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r064-260903-0005.md` | ACTIVE |
| `15` | `15-Action-Registry-r060-260903-0005.md` | ACTIVE |
...
- `TASK-032 Governed Project Repair / Remediation`: IN_PROGRESS / READY; implementation `dd20987`; focused `23/23 PASS`; structural `40/40 PASS`; corrected cumulative AFFECTED `59/59 PASS` / `EVD-060`; prior candidate `5991c9f` invalidated before RELEASE_FULL; corrected candidate freeze next.
...
- Current state: `03-Current-State-r062-260903-0005.md`.
- Continuation: `09-Handoff-r062-260903-0005.md`.
- Evidence: `13-Evidence-Registry-r058-260903-0005.md`.
- Manifest: `14-Project-Source-Manifest-r064-260903-0005.md`.
