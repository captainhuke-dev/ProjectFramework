...
supersedes: "14-Project-Source-Manifest-r083-260906-1635.md"
...
- `01` — `Project-Source/01-Project-Source-Index-r085-260910-1058.md`
- `02` — `Project-Source/02-Project-Overview-r002-260829-1901.md`
- `03` — `Project-Source/03-Current-State-r082-260910-1058.md`
- `04` — `Project-Source/04-Decision-Log-r001-260829-1707.md`
- `05` — `Project-Source/05-Requirements-r001-260829-1707.md`
- `09` — `Project-Source/09-Handoff-r082-260910-1058.md`
- `10` — `Project-Source/10-Change-Log-r079-260910-1058.md`
- `11` — `Project-Source/11-Actor-Registry-r001-260829-1707.md`
- `12` — `Project-Source/12-Authorization-Registry-r028-260910-1058.md`
- `13` — `Project-Source/13-Evidence-Registry-r079-260910-1058.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r085-260910-1058.md`
- `15` — `Project-Source/15-Action-Registry-r080-260910-1058.md`
...
- `91` — `Project-Source/91-Project-Management-Control-r044-260910-1058.md`
...
Design: docs/superpowers/specs/2026-09-10-task046-framework115-reconciliation-design.md
Current-surface drift: README current summary + SKILL Chat-lifecycle wording require bounded correction after written-spec review
Framework mutation at checkpoint: NONE
Publication: NOT_AUTHORIZED / NOT_PUSHED
Evidence/Change: EVD-082 / CHG-082
