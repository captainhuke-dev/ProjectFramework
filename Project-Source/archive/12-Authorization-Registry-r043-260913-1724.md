...
supersedes: "12-Authorization-Registry-r042-260913-1457.md"
...
- **Higher-Level Process Gate:** Superpowers architectural written-spec review must complete before implementation planning/implementation.
- **Status:** ACTIVE.
- **Validity:** until OUT-020 terminal reconciliation or Human revocation/supersession.
- **Authority Transfer:** false.
