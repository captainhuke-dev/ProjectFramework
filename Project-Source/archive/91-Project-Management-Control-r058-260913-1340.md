...
supersedes: "91-Project-Management-Control-r057-260913-1112.md"
...
- **Design Direction:** approved recommended architecture under `EVD-098`.
...
- **Remaining Work:** written spec -> plan -> TDD implementation -> affected verification -> unchanged-candidate RELEASE_FULL -> evidence/terminal reconciliation.
