...
- **Validity:** ACTIVE until OUT-007 terminal state, explicit cancellation/narrowing, or material authority conflict
...
- **Status:** ACTIVE
- **Evidence:** `EVD-053`, `EVD-057`, `EVD-058`, `EVD-059` plus subsequent suite evidence
