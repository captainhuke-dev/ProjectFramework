...
updated_at: "2026-09-01T15:08:00+07:00"
...
→ 01-Project-Source-Index-r030-260901-1508.md
→ 03-Current-State-r030-260901-1508.md
→ task-specific routing
→ 09-Handoff-r030-260901-1508.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r030-260901-1508.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r030-260901-1508.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r030-260901-1508.md` | ACTIVE |
| `10` | `10-Change-Log-r024-260901-1508.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r007-260901-1454.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r024-260901-1508.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r030-260901-1508.md` | ACTIVE |
| `15` | `15-Action-Registry-r028-260901-1508.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r013-260901-1508.md` | ACTIVE |
...
- `TASK-025 Project Knowledge Layer / Compounding Knowledge Contract`: IN_PROGRESS / WRITTEN_SPEC_APPROVED / persistent `OUT-003 / AUTH-003 / ACT-013 / ENV-003`; design `ec9911451f6a1271b473e7f1a02e8e3c1cd3d1f7` PASS 42/42; implementation plan committed `187c802` / self-review 43/43 PASS; Task 1 TDD RED complete: `TASK025_RED 33/68 FAIL` expected, scenarios 269–288 commit `64823a9`; Task 2 normative implementation next; target Framework 1.10.0 / Schema 1.0.0; publication excluded.
...
- Current state: `03-Current-State-r030-260901-1508.md`.
- Continuation: `09-Handoff-r030-260901-1508.md`.
- Evidence: `13-Evidence-Registry-r024-260901-1508.md`.
- Manifest: `14-Project-Source-Manifest-r030-260901-1508.md`.
