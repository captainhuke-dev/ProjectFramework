...
supersedes: "01-Project-Source-Index-r082-260906-1345.md"
...
→ 01-Project-Source-Index-r082-260906-1345.md
→ 03-Current-State-r080-260906-1345.md
→ task-specific routing
→ 09-Handoff-r080-260906-1345.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r082-260906-1345.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r080-260906-1345.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r080-260906-1345.md` | ACTIVE |
| `10` | `10-Change-Log-r076-260906-1345.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r026-260906-1345.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r076-260906-1345.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r082-260906-1345.md` | ACTIVE |
| `15` | `15-Action-Registry-r078-260906-1345.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r042-260906-1345.md` | ACTIVE |

Conditional `06–08`, `40`, `60`, and `92` remain unmaterialized unless applicable. `91` remains ACTIVE for terminal Goal outcome history; OUT-010 publication reconciliation is terminalized in the active revision. `18–19` remain RESERVED.

## Task Routing

- Framework development backlog/lifecycle source: `docs/superpowers/PROJECT-TASKS.md`.
- Framework distribution current root: `Framework-Source/` (Framework 1.14.0 / Schema 1.0.0 is merged to canonical `origin/main` by PR #28 at `eda1f2b`; Project Source post-merge reconciliation checkpoint `0d7fcd4` is persisted and terminal reconciliation is prepared).
...
- Current state: `03-Current-State-r080-260906-1345.md`.
- Continuation: `09-Handoff-r080-260906-1345.md`.
- Evidence: `13-Evidence-Registry-r076-260906-1345.md`.
- Manifest: `14-Project-Source-Manifest-r082-260906-1345.md`.

The derived registry is not manually authoritative over active document state.


## TASK-045 — Response Close + Next Goal
- **State:** IN_PROGRESS / GOAL_ACTIVE / DESIGN_APPROVED_BY_USER_DIRECTION / IMPLEMENTATION_NOT_STARTED.
- **Collision note:** `TASK-044` is already owned by the ProjectFramework 2.0 / AI-ControlTower Protocol Integration V2 line and is not modified by this work.
- **Goal:** `OUT-012 ACTIVE / AUTH-012 ACTIVE / ACT-024 IN_PROGRESS / ENV-012 ACTIVE`.
- **Scope:** change the mandatory visible Framework response close from `[Next Action] → [Chat] → [Reason] → [Required Read]` to `[Next Action] → [Next Goal] → [Reason]`; preserve internal continuity/Handoff semantics; add safe copy-ready `[Goal]` suggestion semantics.
- **Target:** Framework `1.15.0` / Schema `1.0.0` / release format `3`, subject to TDD and release verification.
- **Publication:** NOT_AUTHORIZED / NOT_PUSHED.

## Exact next action
Write/self-review the TASK-045 design spec, then create the implementation plan and RED pressure-scenario contract before production Framework semantics change.
