...
→ 01-Project-Source-Index-r015-260831-1603.md
→ 03-Current-State-r015-260831-1603.md
→ task-specific routing
→ 09-Handoff-r015-260831-1603.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r015-260831-1603.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r015-260831-1603.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r015-260831-1603.md` | ACTIVE |
| `10` | `10-Change-Log-r013-260831-1603.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r001-260829-1707.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r013-260831-1603.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r015-260831-1603.md` | ACTIVE |
| `15` | `15-Action-Registry-r013-260831-1603.md` | ACTIVE |
...
- `TASK-040 [Session] command rename`: DONE; RED `10/26 FAIL` → GREEN `26/26 PASS`; AFFECTED `54/54` PASS; RELEASE_FULL `160/160` PASS; implementation candidate `5b3d4e309976a88e1e57495b6fdaa049fabb6247`; release evidence `docs/superpowers/evidence/2026-08-31-task-040-session-command-rename-release-full.md` committed at `52498bd`; publication `NOT_PUSHED`.
- Next action: decide TASK-040 publication disposition; after publish or explicit defer, `TASK-025 Project Knowledge Layer / Compounding Knowledge Contract` remains the next architectural design task.
- Current state: `03-Current-State-r015-260831-1603.md`.
- Continuation: `09-Handoff-r015-260831-1603.md`.
- Evidence: `13-Evidence-Registry-r013-260831-1603.md`.
- Manifest: `14-Project-Source-Manifest-r015-260831-1603.md`.
