...
→ 01-Project-Source-Index-r069-260903-0047.md
→ 03-Current-State-r067-260903-0047.md
→ task-specific routing
→ 09-Handoff-r067-260903-0047.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r069-260903-0047.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r067-260903-0047.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r067-260903-0047.md` | ACTIVE |
| `10` | `10-Change-Log-r063-260903-0047.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r019-260903-0029.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r063-260903-0047.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r069-260903-0047.md` | ACTIVE |
| `15` | `15-Action-Registry-r065-260903-0047.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r035-260903-0029.md` | ACTIVE |
...
- `TASK-036 Project Change/Event History Feed`: IN_PROGRESS / READY under `OUT-008 / AUTH-008 / ACT-020 / ENV-008`; design `d061f1f` / self-review `27/27 PASS`; foundation implementation planning next.
- `TASK-030 Cross-Project Relation Reconciliation`: IN_PROGRESS / READY; shared design `d061f1f` / self-review `27/27 PASS`; parallel foundation with TASK-036.
- `TASK-029 Cross-Project Impact Analysis`: TODO / WAITING on TASK-036 + TASK-030 suite checkpoints.
- `TASK-031 Project Event & Notification Contract`: TODO / WAITING on TASK-029 + TASK-030; notification delivery/runtime remains out of scope.
- Federated Change Intelligence suite target: Framework 1.14.0 / Schema 1.0.0 / release format 3; design `d061f1f`; plan `95c1ca3`; TDD RED scenarios 381–420 observed `FEDERATED_STRUCTURAL 23/40 PASS` with 17 expected missing-contract failures; TASK-036/TASK-030 foundation implementation next.
- Current state: `03-Current-State-r067-260903-0047.md`.
- Continuation: `09-Handoff-r067-260903-0047.md`.
- Evidence: `13-Evidence-Registry-r063-260903-0047.md`.
- Manifest: `14-Project-Source-Manifest-r069-260903-0047.md`.
