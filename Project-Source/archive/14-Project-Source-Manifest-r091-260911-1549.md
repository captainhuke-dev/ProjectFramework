...
supersedes: "14-Project-Source-Manifest-r090-260911-1459.md"
...
- `01` — `Project-Source/01-Project-Source-Index-r091-260911-1549.md`
- `02` — `Project-Source/02-Project-Overview-r003-260911-1459.md`
- `03` — `Project-Source/03-Current-State-r087-260911-1549.md`
- `04` — `Project-Source/04-Decision-Log-r002-260911-1459.md`
- `05` — `Project-Source/05-Requirements-r002-260911-1459.md`
- `09` — `Project-Source/09-Handoff-r087-260911-1549.md`
- `10` — `Project-Source/10-Change-Log-r085-260911-1549.md`
- `11` — `Project-Source/11-Actor-Registry-r002-260911-1459.md`
- `12` — `Project-Source/12-Authorization-Registry-r032-260911-1549.md`
- `13` — `Project-Source/13-Evidence-Registry-r084-260911-1549.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r091-260911-1549.md`
...
Evidence: EVD-086 / EVD-087 / EVD-088
Changes: CHG-087 / CHG-088
...
All predecessors replaced during the 1.7.0 → 1.15.0 upgrade are preserved under `Project-Source/archive/` and Git history. The pre-terminal metadata revisions `01 r090`, `03 r086`, `09 r086`, `10 r084`, `12 r031`, `13 r083`, `14 r090`, `15 r084`, `16 r004`, and `91 r048` are likewise superseded by this terminal reconciliation and preserved in archive.
