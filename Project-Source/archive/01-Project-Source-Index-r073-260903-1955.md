...
→ 01-Project-Source-Index-r073-260903-1955.md
→ 03-Current-State-r071-260903-1955.md
→ task-specific routing
→ 09-Handoff-r071-260903-1955.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r073-260903-1955.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r071-260903-1955.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r071-260903-1955.md` | ACTIVE |
| `10` | `10-Change-Log-r067-260903-1955.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r019-260903-0029.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r067-260903-1955.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r073-260903-1955.md` | ACTIVE |
| `15` | `15-Action-Registry-r069-260903-1955.md` | ACTIVE |
...
- `TASK-031 Project Event & Notification Contract`: TODO / READY; TASK-029 + TASK-030 dependencies satisfied; NOT_STARTED. Feature branch is PUSHED, but merge to canonical main is blocked until TASK-031 + cumulative AFFECTED + final RELEASE_FULL complete or the release plan is explicitly revised.
- Federated Change Intelligence suite target: Framework 1.14.0 / Schema 1.0.0 / release format 3; design `d061f1f`; plan `95c1ca3`; TDD RED `23/40`; TASK-036 DONE `5c9ed7c`; TASK-030 DONE `360a1ad`; TASK-029 DONE `daf01eb`; TASK-031 READY / NOT_STARTED.
- Current state: `03-Current-State-r071-260903-1955.md`.
- Continuation: `09-Handoff-r071-260903-1955.md`.
- Evidence: `13-Evidence-Registry-r067-260903-1955.md`.
- Manifest: `14-Project-Source-Manifest-r073-260903-1955.md`.
