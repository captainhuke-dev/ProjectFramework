...
- `01` — `Project-Source/01-Project-Source-Index-r013-260831-1038.md`
- `02` — `Project-Source/02-Project-Overview-r002-260829-1901.md`
- `03` — `Project-Source/03-Current-State-r013-260831-1038.md`
- `04` — `Project-Source/04-Decision-Log-r001-260829-1707.md`
- `05` — `Project-Source/05-Requirements-r001-260829-1707.md`
- `09` — `Project-Source/09-Handoff-r013-260831-1038.md`
- `10` — `Project-Source/10-Change-Log-r011-260831-1038.md`
- `11` — `Project-Source/11-Actor-Registry-r001-260829-1707.md`
- `12` — `Project-Source/12-Authorization-Registry-r001-260829-1707.md`
- `13` — `Project-Source/13-Evidence-Registry-r011-260831-1038.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r013-260831-1038.md`
- `15` — `Project-Source/15-Action-Registry-r011-260831-1038.md`
...
Provenance Status: VERIFIED; PR #21 merged exact published head 714108a526db1a492d980690e50b1b484b88f6a1 into prior main eb231ee2d1d83b42455ab2f3cab250d4d442fda0 as merge commit c729a7b19b7cdc6d4dfdd211437d4a0b2f685da7; merged Framework-Source tree remains d66803fc41c540efcf072e9e45eb98c83d1f1bb5; this reconciliation revision is local and not yet published to remote main
```
