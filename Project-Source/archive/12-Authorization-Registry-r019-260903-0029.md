...
- **Validity:** ACTIVE until OUT-008 terminal state, explicit cancellation/narrowing, or material authority conflict
...
- **Status:** ACTIVE
- **Evidence:** `EVD-062` plus subsequent suite evidence
