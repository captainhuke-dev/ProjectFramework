...
supersedes: "91-Project-Management-Control-r058-260913-1340.md"
...
- **Design Direction:** `USER_APPROVED_FINAL_DESIGN / WRITTEN_SPEC_SELF_REVIEWED`; `EVD-098 / EVD-099`.
...
- **Remaining Work:** implementation plan -> TDD implementation -> affected verification -> unchanged-candidate RELEASE_FULL -> release evidence -> terminal reconciliation.
