...
→ 01-Project-Source-Index-r063-260902-2313.md
→ 03-Current-State-r061-260902-2313.md
→ task-specific routing
→ 09-Handoff-r061-260902-2313.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r063-260902-2313.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r061-260902-2313.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r061-260902-2313.md` | ACTIVE |
| `10` | `10-Change-Log-r057-260902-2313.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r017-260902-2313.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r057-260902-2313.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r063-260902-2313.md` | ACTIVE |
| `15` | `15-Action-Registry-r059-260902-2313.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r033-260902-2313.md` | ACTIVE |
...
- `TASK-032 Governed Project Repair / Remediation`: IN_PROGRESS / READY; implementation `dd20987`; focused `23/23 PASS`; candidate `5991c9f` invalidated before RELEASE_FULL for Project Source EOF hygiene; Framework-Source unchanged; corrected state requires full-diff + AFFECTED reverify before new candidate freeze.
...
- Current state: `03-Current-State-r061-260902-2313.md`.
- Continuation: `09-Handoff-r061-260902-2313.md`.
- Evidence: `13-Evidence-Registry-r057-260902-2313.md`.
- Manifest: `14-Project-Source-Manifest-r063-260902-2313.md`.
