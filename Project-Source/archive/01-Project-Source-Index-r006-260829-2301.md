...
→ 01-Project-Source-Index-r006-260829-2301.md
→ 03-Current-State-r006-260829-2301.md
→ task-specific routing
→ 09-Handoff-r006-260829-2301.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r006-260829-2301.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r006-260829-2301.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r006-260829-2301.md` | ACTIVE |
| `10` | `10-Change-Log-r005-260829-2301.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r001-260829-1707.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r005-260829-2301.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r006-260829-2301.md` | ACTIVE |
| `15` | `15-Action-Registry-r005-260829-2301.md` | ACTIVE |
...
- `TASK-024 [Meeting]`: DONE; AFFECTED `55/55` PASS; RELEASE_FULL `314/314` PASS; evidence `docs/superpowers/evidence/2026-08-29-task-024-meeting-llm-council-release-full.md` committed at `a4ab73696e67b6cc921e49eed62322ce477ae740`.
- Next Framework 1.8.0 architectural action: `TASK-026 External AI Context & Disclosure Governance`; prepare its architectural design before implementation.
- Current state: `03-Current-State-r006-260829-2301.md`.
- Continuation: `09-Handoff-r006-260829-2301.md`.
- Evidence: `13-Evidence-Registry-r005-260829-2301.md`.
- Manifest: `14-Project-Source-Manifest-r006-260829-2301.md`.
