...
supersedes: "14-Project-Source-Manifest-r085-260910-1058.md"
...
- `01` — `Project-Source/01-Project-Source-Index-r086-260910-1158.md`
- `02` — `Project-Source/02-Project-Overview-r002-260829-1901.md`
- `03` — `Project-Source/03-Current-State-r083-260910-1158.md`
- `04` — `Project-Source/04-Decision-Log-r001-260829-1707.md`
- `05` — `Project-Source/05-Requirements-r001-260829-1707.md`
- `09` — `Project-Source/09-Handoff-r083-260910-1158.md`
- `10` — `Project-Source/10-Change-Log-r080-260910-1158.md`
- `11` — `Project-Source/11-Actor-Registry-r001-260829-1707.md`
- `12` — `Project-Source/12-Authorization-Registry-r028-260910-1058.md`
- `13` — `Project-Source/13-Evidence-Registry-r080-260910-1158.md`
- `14` — `Project-Source/14-Project-Source-Manifest-r086-260910-1158.md`
- `15` — `Project-Source/15-Action-Registry-r081-260910-1158.md`
...
- `91` — `Project-Source/91-Project-Management-Control-r045-260910-1158.md`

Conditional documents `06–08`, `40`, `60`, `92`: NOT MATERIALIZED unless applicable. `91` remains ACTIVE because management-control outcome history is materially applicable; no TASK-045 Goal remains active.
...
## OUT-013 Framework 1.15 Reconciliation Goal Checkpoint
Goal: OUT-013 ACTIVE / AUTH-013 ACTIVE / ACT-025 IN_PROGRESS / ENV-013 ACTIVE
Framework line: keep 1.15.x / Schema 1.0.0 / release format 3
TASK-045: DONE / VERIFIED_COMPLETE / implementation baseline / historical candidate bc7f91c
TASK-044: CANCELLED / IMPLEMENTATION_NOT_STARTED / V2 head 0ef4e4c preserved
TASK-046: CANCELLED / SUPERSEDED_BEFORE_IMPLEMENTATION / registration b42a2f4 + caf2a19 preserved
Design: docs/superpowers/specs/2026-09-10-task046-framework115-reconciliation-design.md / USER_APPROVED_FINAL_DESIGN / SPEC_APPROVED / f5f8ecf
Plan: docs/superpowers/plans/2026-09-10-out013-framework115-reconciliation.md / OUT013_PLAN_SELF_REVIEW 19/19 PASS / EXECUTION_NOT_STARTED
Current-surface drift: README current summary + SKILL Chat-lifecycle wording + root 00 template rendering example require bounded correction under the approved plan
Framework mutation at checkpoint: NONE
Publication: NOT_AUTHORIZED / NOT_PUSHED
Evidence/Change: EVD-082 / CHG-082; final design + plan checkpoint EVD-083 / CHG-083
