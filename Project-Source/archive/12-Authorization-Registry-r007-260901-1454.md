...
- **Validity:** ACTIVE while OUT-003 is ACTIVE/BLOCKED; terminates prospectively when OUT-003 becomes ACHIEVED/CANCELLED/SUPERSEDED or user revokes/narrows it
- **Verification Requirement:** remain within TASK-025 approved spec and preserve platform/tool/safety/binding/integration gates
- **Status:** ACTIVE
- **Evidence:** `EVD-024`
