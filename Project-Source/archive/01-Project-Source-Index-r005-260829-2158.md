...
→ 01-Project-Source-Index-r005-260829-2158.md
→ 03-Current-State-r005-260829-2158.md
→ task-specific routing
→ 09-Handoff-r005-260829-2158.md when continuation applies
```
...
| `01` | `01-Project-Source-Index-r005-260829-2158.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r005-260829-2158.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r005-260829-2158.md` | ACTIVE |
...
| `14` | `14-Project-Source-Manifest-r005-260829-2158.md` | ACTIVE |
...
- `TASK-024 [Meeting]`: design state `USER_APPROVED_DESIGN / WRITTEN_SPEC_REVIEW_REQUIRED`; committed spec `docs/superpowers/specs/2026-08-29-task024-meeting-llm-council-design.md`; explicit written-spec review is required before implementation planning.
- Current state: `03-Current-State-r005-260829-2158.md`.
- Continuation: `09-Handoff-r005-260829-2158.md`.
- Evidence: `13-Evidence-Registry-r004-260829-1930.md`.
- Manifest: `14-Project-Source-Manifest-r005-260829-2158.md`.
