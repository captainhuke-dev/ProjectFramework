...
- **Validity:** ACTIVE until OUT-006 terminal state, explicit cancellation/narrowing, or material authority conflict
...
- **Status:** ACTIVE
- **Evidence:** `EVD-050` plus subsequent reconciliation evidence
