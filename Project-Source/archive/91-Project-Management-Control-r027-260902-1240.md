...
- **Success Criteria / Success Measure:** (1) written spec approved/self-reviewed/committed; (2) implementation plan committed; (3) scenarios 351–356 demonstrate RED before production change then GREEN; (4) Core defines Strict Governed Interface + Command Contract Completeness Gate; (5) SKILL operational pipeline and `[Project Status]` Continuity align with Core; (6) TASK-042 close semantics unchanged; (7) AFFECTED PASS; (8) one final unchanged-candidate RELEASE_FULL PASS; (9) release evidence committed; (10) TASK-043/Goal/Project Source terminally reconciled with observed completion commit.
- **Evidence Required:** design/plan commits; RED/GREEN outputs; affected/release verification with candidate/tree identity; release evidence commit; terminal reconciliation/final Git observation.
...
- **Last Evaluated:** 2026-09-02T12:40:00+07:00 — design criterion satisfied; implementation criteria pending
- **Current Evidence:** `EVD-043`; task registration `5401fe4`; design checkpoint `f740d16`
