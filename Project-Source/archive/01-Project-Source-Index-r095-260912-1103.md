...
| `01` | `01-Project-Source-Index-r095-260912-1103.md` | ACTIVE |
| `02` | `02-Project-Overview-r003-260911-1459.md` | ACTIVE |
| `03` | `03-Current-State-r091-260912-1103.md` | ACTIVE |
| `04` | `04-Decision-Log-r002-260911-1459.md` | ACTIVE |
| `05` | `05-Requirements-r002-260911-1459.md` | ACTIVE |
| `09` | `09-Handoff-r091-260912-1103.md` | ACTIVE |
| `10` | `10-Change-Log-r089-260912-1103.md` | ACTIVE |
| `11` | `11-Actor-Registry-r002-260911-1459.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r035-260912-1103.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r088-260912-1103.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r095-260912-1103.md` | ACTIVE |
| `15` | `15-Action-Registry-r088-260912-1103.md` | ACTIVE |
| `16` | `16-Migration-Registry-r005-260911-1549.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r002-260911-1459.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r052-260912-1103.md` | ACTIVE |
...
- TASK-047: `DONE` — Response Close UI Rendering Compliance Regression.
- TASK-047 implementation publication: registration `196ddd0d5a2ec7c48c7a9232bafc909b0284522b` + terminal `bc880c75190f967a3b87c2842b8cc284f8a3bcab`, freshly observed on `origin/main` before this reconciliation.
- Publication reconciliation Goal: `OUT-016 ACHIEVED / AUTH-016 TERMINATED / ACT-028 DONE / ENV-016 EXPIRED`.
- Publication evidence/change: `EVD-092 / CHG-092`.
- Publication state: `PUBLISHED_TO_ORIGIN_MAIN / PERSISTED / NOT_PENDING` when this active reconciliation is read from canonical `origin/main`.
- Framework-Source remains unchanged at tree `835c5a24c909ef7de2d413c46a6451746ed5fbf0`.
