...
supersedes: "01-Project-Source-Index-r088-260910-2133.md"
...
| `01` | `01-Project-Source-Index-r089-260910-2220.md` | ACTIVE |
| `02` | `02-Project-Overview-r002-260829-1901.md` | ACTIVE |
| `03` | `03-Current-State-r085-260910-2220.md` | ACTIVE |
| `04` | `04-Decision-Log-r001-260829-1707.md` | ACTIVE |
| `05` | `05-Requirements-r001-260829-1707.md` | ACTIVE |
| `09` | `09-Handoff-r085-260910-2220.md` | ACTIVE |
| `10` | `10-Change-Log-r083-260910-2220.md` | ACTIVE |
| `11` | `11-Actor-Registry-r001-260829-1707.md` | ACTIVE |
| `12` | `12-Authorization-Registry-r030-260910-2220.md` | ACTIVE |
| `13` | `13-Evidence-Registry-r082-260910-2220.md` | ACTIVE |
| `14` | `14-Project-Source-Manifest-r089-260910-2220.md` | ACTIVE |
| `15` | `15-Action-Registry-r083-260910-2220.md` | ACTIVE |
| `16` | `16-Migration-Registry-r003-260829-1916.md` | ACTIVE |
| `17` | `17-Secret-Reference-Registry-r001-260829-1707.md` | ACTIVE |
| `91` | `91-Project-Management-Control-r047-260910-2220.md` | ACTIVE |
...
- Framework distribution current root: `Framework-Source/` (verified Framework 1.15.0 / Schema 1.0.0; OUT-014 is ACTIVE to fast-forward/publish the verified 1.15 lineage to canonical `origin/main`, then prepare governed `[Project Upgrade]` of this Project from local pin 1.7.0 to 1.15.0. Until publication succeeds, canonical `origin/main` remains Framework 1.14.0.)
...
## OUT-014 — Publish Framework 1.15 and upgrade ProjectFramework to 1.15
- **State:** OUT-014 ACTIVE / AUTH-014 ACTIVE / ACT-026 IN_PROGRESS / ENV-014 ACTIVE.
- **Phase 1:** exact fast-forward integration/publication of verified Framework 1.15 lineage to canonical `main` / `origin/main`, non-force only, with fresh remote resulting-state verification.
- **Phase 2:** after canonical publication is verified, execute `[Project Upgrade]` comparison and cumulative Direct-to-Latest assessment from Project Source pin 1.7.0 to target 1.15.0; materialize Upgrade Preview before any Root/Project Source mutation.
- **Mutation gate:** Project Upgrade Root/Project Source mutation remains NOT_YET_AUTHORIZED until the post-comparison Preview is presented and separate explicit mutation approval is captured.
- **Evidence basis:** EVD-085; prior OUT-013 evidence EVD-084 / release-evidence commit `009b4dbd5de93f56d5f9eb1c2ce1a1dedc4eedb7`; verified branch head before Goal checkpoint `c21145e1efe56bdc03791249e11c8ba42b84f93b`.
- **Exact Next Action:** validate this Goal checkpoint, then fast-forward local `main` and push exact Goal-checkpoint head to `origin/main` with no force.