...
supersedes: "12-Authorization-Registry-r022-260905-1118.md"
...
- **Validity:** ACTIVE until OUT-012 terminal, explicit revocation/supersession, material scope conflict, or risk exceeds bounded local scope
- **Verification Requirement:** written spec + plan; TDD RED before production semantics; affected verification; one final unchanged-candidate RELEASE_FULL; release evidence; observed completion commit
- **Status:** ACTIVE
- **Evidence:** EVD-079 and subsequent state-bound evidence
