...
- **Validity:** active while OUT-003 is ACTIVE/BLOCKED; terminates prospectively when OUT-003 becomes ACHIEVED/CANCELLED/SUPERSEDED or user revokes/narrows authority
- **Verification Requirement:** remain within TASK-042 scope and preserve current Framework safety/tool/platform gates
- **Status:** ACTIVE
- **Evidence:** EVD-023
