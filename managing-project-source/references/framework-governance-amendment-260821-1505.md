...
6. `STALE_NON_SEMANTIC` may be resolved with `REBASE_REQUIRED` for private/rewritable work when appropriate. Shared/public branches may use a history-preserving merge/update strategy instead; Framework does not require published-history rewriting.
