...
Current distribution: **Framework 1.9.1 / Schema 1.0.0**.
...
- `references/framework-governance-amendment-260901-task042.md` — latest amendment: Response Finalization Hardening (current authority)
- `references/framework-governance-amendment-260831-task041.md` — previous amendment: Portable Installation Bootstrap & Project Settings Handoff
...
First-response bootstrap and unskippable finalization specialize the Framework 1.9.0 portable installation contract: local Project governance is resolved before the first Project-governed response when accessible; read-only/status/diagnostic/failure-report responses are not exempt; no early-return/exception path bypasses the Response Close Completeness Gate. The response-close format and authority model are unchanged.
